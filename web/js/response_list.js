 ...
 */
 ...
 var response_list = [
	...
	{group_id:3, prompt_id:4, text:'How often did you feel that you were unable to control the important things in your life today?', type:2, y_labels:['Rarely', 'Sometimes', 'Often']},
	{group_id:3, prompt_id:5, text:'How often did you feel confident about your ability to handle your personal problems today?', type:2, y_labels:['Rarely', 'Sometimes', 'Often']},
	{group_id:3, prompt_id:6, text:'How often did you feel that things were going your way today?', type:2, y_labels:['Rarely', 'Sometimes', 'Often']},
	{group_id:3, prompt_id:7, text:'How often did you find that you could not cope with all the things that you had to do today?', type:2, y_labels:['Rarely', 'Sometimes', 'Often']},
	{group_id:3, prompt_id:8, text:'How often did you feel difficulties were piling up so high that you could not overcome them?', type:2, y_labels:['Rarely', 'Sometimes', 'Often']},
	...
	{group_id:3, prompt_id:18, text:'If yes, how stressful was this?', type:2, y_labels:['Not at all', 'Slightly', 'Moderately', 'Very']},
	{group_id:3, prompt_id:19, text:'Did anything happen today that was enjoyable or felt good to you?', type:3},
	{group_id:3, prompt_id:20, text:'If yes, how enjoyable was this?', type:2, y_labels:['Not at all', 'Slightly', 'Moderately', 'Very']},
 ];
