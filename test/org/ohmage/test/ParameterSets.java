...
public class ParameterSets {
  ...
  /**
   * Returns the unmodifiable collection of valid username, campaign role lists.
   *
   * @return The unmodifiable collection of valid username, campaign role lists.
   */
  ...
  /**
   * Returns the unmodifiable collection of invalid username, class role lists.
   *
  ...
  /**
   * Returns the unmodifiable collection of valid username, document role lists.
   *
   * @return The unmodifiable collection of valid username, document role lists.
   */
  ...
  /**
   * Returns the unmodifiable collection of valid lists that contain no specific
   * data.
   *
   * @return The unmodifiable collection of valid lists that contain no specific
   * data.
   */
  ...
  /**
   * Returns a map of Date objects and their corresponding String representation
   * that includes both their date and time values.
   *
   * @return A map of Date objects and their corresponding String representation
   * that includes both their date and time values.
   */
  ...
  /**
   * Populates the valid and invalid URN collections with all of the valid and
   * invalid URN values that we will use for testing.
   */
  ...
  /**
   * Populates the valid and invalid URN, campaign role and URN, document role
   * collections.
   */
  ...
  /**
   * Populates the collection of simple, valid lists. The lists may or may not
   * contain meaningful data, but they will never be null or whitespace only.
   */
  ...
  private static void initDateValues() {
    ...
    TimeZone tz = epochCalendar.getTimeZone();
    int offset = tz.getOffset(0) * -1;
    ...
    epochCalendar.setTimeInMillis(offset);
    ...
    dateToString.put(new DateTime(offset), "1970-01-01");
    dateTimeToString.put(new DateTime(offset), "1970-01-01 00:00:00");
