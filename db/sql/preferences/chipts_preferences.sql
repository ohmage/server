-- Preferences for a CHIPTS deployment.
INSERT INTO preference(p_key, p_value) VALUES 
    ('default_can_create_privilege', 'false'), 
    ('default_survey_response_sharing_state', 'invisible'),
...
One of our goals is to put you in control of your data. It is also important for system administrators and research supervisors to have access to your data in order to interpret patterns, perform research, and fix system problems. The AndWellness team will put your privacy first and we will never share your data with a third-party.
...
2. The UCLA IRB information can be found here: http://ohrpp.research.ucla.edu/pages/about-irb
    ...
    ('mail_registration_subject', 'AndWellness: New Account Request'),
    ...
    ('mail_password_reset_subject', 'AndWellness: Password Reset'),
