...
We will collect as much data as is required by our system and that you offer to our system, no more, no less. We will keep the data as secure as possible, but you recognize that bad things may happen and data may be lost or stolen. We make every effort to keep our systems as secure as possible.

Any website collects information about its users. This typically includes data about the device being used (be it a web browser or a smartphone application), the IP address of the system making requests, HTTP cookies, request timestamps and timezones, and any data (including images) being provided to interact with the various application functions. In addition to the standard HTTP headers and payloads just described, ohmage also collects location information, system analytics regarding smartphone usage, user activity data (your mobility mode), and your email address if you have self-registered. By using the ohmage smartphone application, you acknowledge that this information is being collected about you and your activities. If you are a software developer, the ohmage server APIs are fully documented on GitHub [1].

Why We Collect This Data

ohmage is designed for the analysis of scripted self-report (survey) data, smartphone analytics data, and user mobility data. All of these data streams can be combined together to provide useful information to end users, researchers, clinicians and students from a wide variety of application domains. If you are a participant in a study in a domain of research around health behaviors, you will be given a very thorough explanation about the study and the information collected. This process is handled by the IRB (Institutional Review Board) from various institutions [2]. Each research study has its own IRB application that is thoroughly vetted and approved by an IRB before the study can begin.

When data for a particular study is very sensitive, the ohmage team at CENS-MobilizeLabs is responsible for creating accounts, and, specifically, for providing anonymized usernames and for not collecting any personally identifiable information to link to the anonymized usernames. In these research studies, system administrators and researchers do have access to participant self-report data, location information, smartphone analytics data, and mobility data. The teams that do have access to this data have gone through IRB training with regards to handling sensitive data in a way that is respectful of participant privacy and that adheres to the rules set forth by the IRB.
...
For passively collected data such as smartphone analytics and mobility modes, the data is private to you, system administrators, and research supervisors. This information is used to analyze self-report data along different axes. For example, your mobility modes may be compared to your self-reports about sleep in a sleep study. Another example is the ability to view mobility modes on a map to determine travel patterns.
