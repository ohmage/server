...
INSERT INTO prompt_type (type, restriction) VALUES
  ...
  ("map", "{0:Never,1:Almost never,2:Aometimes,3:Fairly often,4:Very often}"),
...
INSERT INTO prompt (prompt_type_id, campaign_prompt_group_id, campaign_prompt_version_id, prompt_config_id, parent_config_id, question_text, legend_text) VALUES
  ...
  (8, 4, 1, 11, NULL, "If yes, what type of exercise did you today?","type of exercise"),
  (13, 4, 1, 12, NULL, "If you exercised, for how many minutes did you exercise?","how many minutes did you exercise"),
  ...
  (6, 4, 1, 19, NULL, "If so, how stressful was this?","how stressful"),
  (10, 4, 1, 20, NULL, "Did anything happen today that was enjoyable or felt good to you?","did anything enjoyable happen"),
  (6, 4, 1, 21, NULL, "If so, how enjoyable was this?","how enjoyable");
