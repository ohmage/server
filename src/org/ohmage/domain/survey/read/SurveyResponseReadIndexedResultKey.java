...
public class SurveyResponseReadIndexedResultKey {
	...
	public SurveyResponseReadIndexedResultKey(String username, String timestamp, String surveyId, String repeatableSetId, Integer repeatableSetIteration) {
		if(null == username) {
	...
	public boolean keysAreEqual(String username, String timestamp, String surveyId, String repeatableSetId, Integer repeatableSetIteration) {
		if(null == username) {
		...
		return _username.equals(username) && _timestamp.equals(timestamp) && _surveyId.equals(surveyId) 
	...
	public String toString() {
		return "SurveyResponseReadIndexedResultKey [_username=" + _username
				+ ", _timestamp=" + _timestamp + ", _surveyId=" + _surveyId
