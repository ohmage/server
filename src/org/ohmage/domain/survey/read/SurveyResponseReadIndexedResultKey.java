...
public class SurveyResponseReadIndexedResultKey {
	...
	public SurveyResponseReadIndexedResultKey(String username, Long epochMillis, String surveyId, String repeatableSetId, Integer repeatableSetIteration) {
		if(null == username) {
...
//		}
		...
		return _username.equals(username) && (_epochMillis == epochMillis) && _surveyId.equals(surveyId) 
