...
public class MobilityPoint implements Comparable<MobilityPoint> {
	...
	public static final class ClassifierData {
		 ...
		 * @author John Jenkins
		 */
		public enum ClassifierDataColumnKey implements ColumnKey {
			/**
			 ...
			 */
			N95_VARIANCE ("n95variance", "n95_v"),
			/**
		...
		private ClassifierData(
			...
			try {
				tN95Variance = 
						classifierData.getDouble(
							ClassifierDataColumnKey.N95_VARIANCE.toString(
								false));
			}
			catch(JSONException notRegular) {
				try {
		...
		public final JSONObject toJson(
			...
			if(columns.contains(ClassifierDataColumnKey.N95_VARIANCE)) {
				result.put(
					ClassifierDataColumnKey.N95_VARIANCE.toString(abbreviated), 
					n95Variance);
			}
		...
		public final void toCsvRow(
			...
			if((index = columns.indexOf(ClassifierDataColumnKey.N95_VARIANCE)) != -1) {
				result.set(index, n95Variance);
			}
