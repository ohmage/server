...
public class SurveyResponse {
	...
	public SurveyResponse(final long surveyResponseId,
			...
			final String client, final Configuration campaign,
	...
	private Map<Integer, Response> processResponses(
		...
		for(String surveyItemId : surveyItems.keySet()) {
			boolean found = false;
	...
	/**
	 * Creates a PromptResponse object that represents this prompt response.
	 * 
	 * @param campaign The campaign definition.
	 * 
	 ...
	 * 
	 * @param repeatableSetIteration The iteration of the repeatable set.
	 * 
	 * @return A PromptResponse object that represents this prompt response.
	 * 
	 * @throws ErrorCodeException Thrown if the JSON is malformed.
	 */
	...
	/**
	 * Creates a RepeatableSetResponse object that represents the repeatable
	 * set from a JSONObject.
	 * 
	 * @param campaign The campaign definition.
	 * 
	 * @param repeatableSetId The unique identifier for this repeatable set.
	 * 
	 * @param response The response as a JSONObject.
	 * 
	 * @return A RepeatableSetResponse object that represents this repeatable
	 * 		   set.
	 * 
	 * @throws ErrorCodeException Thrown if the repeatable set is malformed.
	 */
