...
public abstract class BinController {
	...
	/**
	 * The property key for the database user-name.
	 */
	...
	/**
	 * The user-name of the user to use to connect to the database. This may be
	 ...
	 *
	 * @return The user-name to use to connect to the database. This may be
	 *         null.
	 */
