...
public interface IAuditQueries {
	...
	void createAudit(
			...
			final Map<String, String[]> extras, final String response,
			final long receivedMillis, final long respondMillis)
	 ...
	 * @return A list of audit IDs.
	 */
	List<Long> getAllAuditsWithUri(String uri) throws DataAccessException;
	 ...
	 * @return A list of audit IDs.
	 */
	List<Long> getAllAuditsWithResponse(ResponseType responseType, final String errorCode) throws DataAccessException;
	 ...
	 * 		   ID.
	 */
	List<Audit> readAuditInformation(final List<Long> auditIds) throws DataAccessException;
}