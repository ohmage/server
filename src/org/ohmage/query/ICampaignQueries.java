...
public interface ICampaignQueries {
	 ...
	 */
	Campaign findCampaignConfiguration(final String campaignId)
	 ...
	 */
	List<String> getCampaignsOnOrAfterDate(Calendar date)
			throws DataAccessException;
	 ...
	 * @return A List of campaign IDs. This will never be null.
	 */
	List<String> getCampaignsOnOrBeforeDate(Calendar date)
			throws DataAccessException;
