...
public final class UserValidators {
	 ...
	 * 
	 * @param value
	 *        The String representation of the class creation privilege value
	 *        to be validated.
	 * 
	 * @return Returns null if the value is null or whitespace only; otherwise,
	 *         the value is returned.
	 ...
	 *         valid class creation privilege value.
	 */
	public static Boolean validateClassCreationPrivilegeValue(
		final String value)
		throws ValidationException {
		
		LOGGER
			.info(
				"Validating that the value is a valid class creation " +
					"privilege value.");
