...
public class OmhReadRunKeeperRequest
	...
	/**
	 * The allowed paths to use against the Health Graph API.
	 *
	 * @author John Jenkins
	 */
	public abstract static class RunKeeperApi implements OmhReadResponder {
		...
		/**
		 * The formatter that is used to parse and print the date time based on
		 * the {@link DATE_TIME_RESPONSE_FORMAT_STRING response format string}. 
		 * 
		...
		/**
		 * Builds the {@link RunKeeperApi} enum with its default path against
		 * the {@link BASE_URL base URL}.
		 * 
		 * @param path The path for the {@link BASE_URL base URL}.
		 * 
		 ...
		 * 
		 * @return A URL built from the {@link BASE_URL base URL} and this 
		 * 		   path.
		 * 
		...
		/**
		 * Makes the request to the API and stores the recieved data.
		 * 
	...
	public static class ProfileApi extends RunKeeperApi {
		 ...
		 * the {@link RunKeeperRequest#BASE_URL base URL}.
		 */
		...
		public void makeRequest(
			...
			try {
				JsonParser parser = 
					(new MappingJsonFactory()).createJsonParser(result);
	...
	public static class FitnessActivitiesApi extends RunKeeperApi {
		...
		public void makeRequest(
			...
			try {
				JsonParser parser = 
					(new MappingJsonFactory()).createJsonParser(resultString);
