...
/**
 * A survey response privacy state visualization request.
 * 
 * @author John Jenkins
 */
public class VizSurveyResponsesPrivacyStateRequest extends VisualizationRequest {
	/**
	 ...
	 */
	public VizSurveyResponsesPrivacyStateRequest(String token, String width, String height, String campaignId, String privacyState, String startDate, String endDate) {
