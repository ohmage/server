...
/**
 * Builds a survey response privacy state over time visualization request.
 * 
 * @author John Jenkins
 */
public class VizSurveyResponsesPrivacyStateTimeRequestCreator implements AwRequestCreator {
	private static final Logger _logger = Logger.getLogger(VizSurveyResponsesPrivacyStateTimeRequestCreator.class);
	
	/**
	 * Default constructor.
	 */
	public VizSurveyResponsesPrivacyStateTimeRequestCreator() {
		// Do nothing.
	}
