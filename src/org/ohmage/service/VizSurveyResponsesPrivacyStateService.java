 ...
 * request. Specifically, it calls the R survey responses privacy state API.
 * 
 * @author John Jenkins
 */
public class VizSurveyResponsesPrivacyStateService extends AbstractAnnotatingService {
	private static final Logger _logger = Logger.getLogger(VizSurveyResponsesPrivacyStateService.class);
	 ...
	 * 					server fails.
	 */
	public VizSurveyResponsesPrivacyStateService(AwRequestAnnotator annotator) {
		super(annotator);
	}
