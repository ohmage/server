...
public final class UserClassServices {
	 ...
	 */
	public static void userHasRoleInClass(Request request, String username, String classId, String classRole) throws ServiceException {
		try {
	 ...
	 * 							error.
	 */
	public static void userHasRoleInClasses(Request request, String username, Collection<String> classIds, String classRole) throws ServiceException {
		for(String classId : classIds) {
