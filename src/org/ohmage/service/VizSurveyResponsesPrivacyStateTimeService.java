 ...
 * request. Specifically, it calls the R survey responses privacy state over 
 * time API.
 * 
 * @author John Jenkins
 */
public class VizSurveyResponsesPrivacyStateTimeService extends AbstractAnnotatingService {
private static final Logger _logger = Logger.getLogger(VizSurveyResponsesPrivacyStateTimeService.class);
	 ...
	 * 					server fails.
	 */
	public VizSurveyResponsesPrivacyStateTimeService(AwRequestAnnotator annotator) {
		super(annotator);
	}
	...
	public void execute(AwRequest awRequest) {
		...
		urlBuilder.append("sharedtimeplot?");
