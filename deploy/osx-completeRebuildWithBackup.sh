...
/opt/aw/thirdparty/mysql-5.1.40-osx10.5-x86_64/bin/mysql -u andwellness -h localhost -P 3306 -S /opt/aw/dbs/logs/dbsd.sock -p <$2

echo Installing the configurations.

# Install the configurations
java -jar /opt/aw/conf/andwellness-config-loader-1.0.jar /opt/aw/nih-all.xml /opt/aw/conf/loader.properties /opt/aw/conf/configuration-1.0.xsd
java -jar /opt/aw/conf/andwellness-config-loader-1.0.jar /opt/aw/chipts-all-surveys.xml /opt/aw/conf/loader.properties /opt/aw/conf/configuration-1.0.xsd
